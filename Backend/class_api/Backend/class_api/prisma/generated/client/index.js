...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "Backend/class_api/prisma/generated/client",
    "class_api/prisma/generated/client",
  ]
...
path.join(process.cwd(), "Backend/class_api/prisma/generated/client/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "Backend/class_api/prisma/generated/client/schema.prisma")
